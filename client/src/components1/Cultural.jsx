...
const Cultural = () => {
    ...
    useEffect(() => {
        ...
        setMessages([{ text: 'Welcome to the Cultural chatbot! Ask me anything about cultural activities.', sender: 'bot' }]);
    }, []);
    ...
    const sendMessage = async () => {
        ...
        setMessages(prevMessages => {
            ...
            const filteredMessages = prevMessages.filter(msg => msg.text !== 'Welcome to the Cultural chatbot! Ask me anything about cultural activities.');
