...
const GenInfo = () => {
  ...
  // Initialize the welcome message when the component mounts
  useEffect(() => {
    setMessages([
      { text: 'Welcome to the General Information chatbot! Ask me anything about general information.', sender: 'bot' }
    ]);
  }, []);
  ...
  const sendMessage = async () => {
    ...
    setMessages(prevMessages => {
      ...
      const filteredMessages = prevMessages.filter(msg => msg.text !== 'Welcome to the General Information chatbot! Ask me anything about general information.');
