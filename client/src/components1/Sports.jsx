...
const Sports = () => {
  ...
  useEffect(() => {
    ...
    setMessages([{ text: 'Welcome to the Sports chatbot! Ask me anything about sports activities.', sender: 'bot' }]);
  }, []);
  ...
  const sendMessage = async () => {
    ...
    setMessages(prevMessages => {
      ...
      const filteredMessages = prevMessages.filter(msg => msg.text !== 'Welcome to the Sports chatbot! Ask me anything about sports activities.');
